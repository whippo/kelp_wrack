...
young_sporophyte_cohort %>%
  ...
  ggplot() +
  geom_point(aes(x = monthday, y = (Stipe/1400), col = cohort), alpha = 0.4) +
  scale_y_continuous(
    name = "Stipe Length (cm)", lim = c(0,0.018), breaks = seq(0, 0.018, by = 0.0036), labels = c("0", "5", "10", "15", "20", "25"), 
  ...
  annotate(geom = "text", x = as.Date('2020-11-15'), y = 0.017, label = "n = 4661")
